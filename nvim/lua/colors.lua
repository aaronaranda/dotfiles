...
cmd [[hi CursorLine ctermfg=NONE ctermbg=black]] 
...
cmd[[au VimEnter * highlight LineNr ctermfg=NONE ctermbg=black]]
...
cmd[[hi Conceal ctermfg=NONE ctermbg=NONE]]
cmd[[hi Comments cterm=italic]]
